...
import React__default, { Component, createContext, useContext, useState, useEffect, startTransition, Suspense, useRef, useMemo } from "react";
...
function SEO({ title, description, image, url = "/", type = "website", noIndex = false, language = "es", alternates }) {
  const siteUrl2 = "https://www.epmwellness.com";
  const fullUrl = new URL(url, siteUrl2).toString();
  const defaultImage = `${siteUrl2}/assets/eva-perez-profile.webp`;
  ...
  return /* @__PURE__ */ jsxs(Helmet, { children: [
    ...
    !noIndex && /* @__PURE__ */ jsx("link", { rel: "canonical", href: fullUrl }),
    !noIndex && alternates && Object.entries(alternates).map(([alternateLanguage, alternateUrl]) => /* @__PURE__ */ jsx(
      "link",
      {
        rel: "alternate",
        hrefLang: alternateLanguage,
        href: new URL(alternateUrl, siteUrl2).toString()
      },
      alternateLanguage
    )),
    /* @__PURE__ */ jsx("meta", { property: "og:type", content: type }),
    !noIndex && /* @__PURE__ */ jsx("meta", { property: "og:url", content: fullUrl }),
    ...
    !noIndex && /* @__PURE__ */ jsx("meta", { property: "twitter:url", content: fullUrl }),
...
const ResourcesPage = React__default.lazy(() => Promise.resolve().then(() => Resources$1));
const ChatBot$2 = React__default.lazy(() => Promise.resolve().then(() => ChatBot$1));
function Router() {
  const [location] = useLocation();
  return /* @__PURE__ */ jsx(Suspense, { fallback: /* @__PURE__ */ jsx(PageLoader, {}), children: /* @__PURE__ */ jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxs(Switch, { location, children: [
    ...
    /* @__PURE__ */ jsx(Route, { path: "/resources", children: /* @__PURE__ */ jsx(ResourcesPage, { isPage: true }) }),
...
function App({ queryClient: propsClient }) {
  ...
  return /* @__PURE__ */ jsx(QueryClientProvider, { client, children: /* @__PURE__ */ jsx(AuthProvider, { children: /* @__PURE__ */ jsxs(LanguageProvider, { children: [
    ...
    /* @__PURE__ */ jsx(Suspense, { fallback: null, children: /* @__PURE__ */ jsx(ChatBot$2, {}) }),
...
const AnimatedCounter = ({
  ...
  const [count2, setCount] = useState(end);
  ...
  return /* @__PURE__ */ jsx("section", { id: "testimonials", className: "py-16 md:py-24 bg-gray-50", children: /* @__PURE__ */ jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "flex justify-center mt-6 space-x-2", children: Array.from({ length: maxSlide + 1 }).map((_, index) => /* @__PURE__ */ jsx(
      "button",
      {
        ...
        "aria-current": currentSlide === index ? "true" : void 0
      },
      index
    )) })
  ] }) });
...
const Resources$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: Resources
                      ...
                      /* @__PURE__ */ jsxs(FormLabel, { children: [
                        ...
                        /* @__PURE__ */ jsx(
                          Link,
                          {
                            ...
                            children: language === "es" ? "política de privacidad" : "privacy policy"
                          }
                        )
                      ] }),
...
const blogAlternates = Object.fromEntries(
  pairs.flatMap(([es2, en]) => [
    [es2, { es: `/blog/${es2}`, en: `/blog/${en}` }],
    [en, { es: `/blog/${es2}`, en: `/blog/${en}` }]
  ])
);
function BlogPostPage() {
  ...
  const structuredData = {
    ...
    "publisher": {
      ...
      "image": {
        "@type": "ImageObject",
        "url": `${siteUrl2}/assets/eva-perez-profile.webp`
      }
    },
...
const ChatBot = () => {
  ...
  return /* @__PURE__ */ jsxs("div", { id: "chatbot-container", className: "relative", children: [
    ...
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        className: "chatbot-launcher fixed bottom-6 right-6 z-50 flex flex-col items-end",
        initial: { opacity: 0, y: 20 },
        animate: { opacity: 1, y: 0 },
        transition: { delay: 1 },
        children: [
...
const ChatBot$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: ChatBot
}, Symbol.toStringTag, { value: "Module" }));
export {
