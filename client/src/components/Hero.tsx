    ...
    <div className="relative pt-10 pb-20 md:pb-24 md:pt-32 lg:pt-40 lg:pb-32 overflow-hidden min-h-[100vh] sm:min-h-0">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        {isMobile ? (
          ...
          >
            <div className="bg-charcoal/90 py-3 px-4 rounded-t-lg backdrop-blur-md w-full">
              ...
              <div className="flex flex-row gap-2">
                <a href="#services" className="bg-turquoise hover:bg-turquoise-dark text-white font-medium px-4 py-2 rounded transition-colors inline-block text-center text-xs flex-1">
                  {language === 'es' ? "Mis servicios" : "My services"}
                </a>
                <a href="#contact" className="bg-white hover:bg-gray-100 text-turquoise-dark font-medium px-4 py-2 rounded transition-colors inline-block text-center text-xs flex-1">
